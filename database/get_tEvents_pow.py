...
# Output file name
output_name = 'tEvents_pow_'+t_min_pw+'_'+t_max_pw+'_gamma_'+gamma+'_tend_'+maxTime+'_'+nb_run+'runs.in'
t_min_pw = float(t_min_pw)
t_max_pw = float(t_max_pw)
